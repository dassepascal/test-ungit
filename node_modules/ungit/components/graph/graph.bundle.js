...
var ActionBase = /** @class */ (function () {
    ...
    ActionBase.prototype.doPerform = function () {
        ...
        this.isRunning(true);
        return this.perform()["catch"](function (e) { return _this.server.unhandledRejection(e); })["finally"](function () {
...
var Rebase = /** @class */ (function (_super) {
    ...
    Rebase.prototype.perform = function () {
        var _this = this;
        return this.server
            .postPromise('/rebase', { path: this.graph.repoPath(), onto: this.node.sha1 })["catch"](function (err) {
...
var CherryPick = /** @class */ (function (_super) {
    ...
    CherryPick.prototype.perform = function () {
        var _this = this;
        return this.server
            .postPromise('/cherrypick', { path: this.graph.repoPath(), name: this.node.sha1 })["catch"](function (err) {
            if (err.errorCode != 'merge-failed') {
                _this.server.unhandledRejection(err);
            }
            else {
...
var GitNodeViewModel = /** @class */ (function (_super) {
    ...
    GitNodeViewModel.prototype.createBranch = function () {
        ...
        })["catch"](function (e) { return _this.graph.server.unhandledRejection(e); })["finally"](function () {
    ...
    GitNodeViewModel.prototype.createTag = function () {
        ...
        this.graph.server
            ...
            .then(function () { return _this.graph.getRef("refs/tags/".concat(_this.newBranchName())).node(_this); })["catch"](function (e) { return _this.graph.server.unhandledRejection(e); })["finally"](function () {
            _this.branchingFormVisible(false);
            _this.newBranchName('');
        });
    };
...
var RefViewModel = /** @class */ (function (_super) {
    ...
    RefViewModel.prototype.remove = function (isClientOnly) {
        ...
        })["catch"](function (e) { return _this.server.unhandledRejection(e); })["finally"](function () {
            if (!isClientOnly) {
                if (url == '/remote/tags') {
...
var GraphViewModel = /** @class */ (function (_super) {
    ...
    function GraphViewModel(server, repoPath) {
        ...
        _this.showCommitNode = ko.observable(false);
