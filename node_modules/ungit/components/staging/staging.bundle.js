...
var StagingViewModel = /** @class */ (function (_super) {
    ...
    StagingViewModel.prototype.conflictResolution = function (apiPath) {
        ...
        if (this.commitMessageBody())
            commitMessage += "\n\n".concat(this.commitMessageBody());
        this.server
            .postPromise(apiPath, { path: this.repoPath(), message: commitMessage })["catch"](function (e) { return _this.server.unhandledRejection(e); })["finally"](function () {
            _this.resetMessages();
        });
    };
        ...
        components.showModal('yesnomodal', {
            ...
            closeFunc: function (isYes) {
                if (!isYes)
                    return;
                _this.server
                    .postPromise('/discardchanges', { path: _this.repoPath(), all: true })["catch"](function (e) { return _this.server.unhandledRejection(e); });
            }
        });
    };
    StagingViewModel.prototype.stashAll = function () {
        var _this = this;
        this.server
            .postPromise('/stashes', { path: this.repoPath(), message: this.commitMessageTitle() })["catch"](function (e) { return _this.server.unhandledRejection(e); });
    };
...
var FileViewModel = /** @class */ (function () {
    ...
    FileViewModel.prototype.discardChanges = function () {
        ...
        if (ungit.config.disableDiscardWarning || isMuteWarning) {
            this.server
                .postPromise('/discardchanges', { path: this.staging.repoPath(), file: this.name() })["catch"](function (e) { return _this.server.unhandledRejection(e); });
        }
        else {
            components.showModal('yesnomutemodal', {
                ...
                closeFunc: function (isYes, isMute) {
                    if (isYes) {
                        _this.server
                            .postPromise('/discardchanges', { path: _this.staging.repoPath(), file: _this.name() })["catch"](function (e) { return _this.server.unhandledRejection(e); });
                    }
                    if (isMute) {
    ...
    FileViewModel.prototype.ignoreFile = function () {
        var _this = this;
        this.server
            .postPromise('/ignorefile', { path: this.staging.repoPath(), file: this.name() })["catch"](function (err) {
    ...
    FileViewModel.prototype.resolveConflict = function () {
        var _this = this;
        this.server
            .postPromise('/resolveconflicts', { path: this.staging.repoPath(), files: [this.name()] })["catch"](function (e) { return _this.server.unhandledRejection(e); });
    };
