...
var StashItemViewModel = /** @class */ (function () {
    ...
    StashItemViewModel.prototype.apply = function () {
        var _this = this;
        this.server
            .delPromise("/stashes/".concat(this.id), { path: this.stash.repoPath(), apply: true })["catch"](function (e) { return _this.server.unhandledRejection(e); });
    };
        ...
        components.showModal('yesnomodal', {
            ...
            closeFunc: function (isYes) {
                if (!isYes)
                    return;
                _this.server
                    .delPromise("/stashes/".concat(_this.id), { path: _this.stash.repoPath() })["catch"](function (e) { return _this.server.unhandledRejection(e); });
            }
        });
    };
