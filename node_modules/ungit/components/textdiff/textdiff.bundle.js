...
var TextDiffViewModel = /** @class */ (function () {
    ...
    TextDiffViewModel.prototype.getPatchCheckBox = function (symbol, index, isActive) {
        ...
        return "<div class=\"d2h-code-line-prefix\"><span data-bind=\"visible: editState() !== 'patched'\">".concat(symbol, "</span><input ").concat(isActive ? 'checked' : '', " type=\"checkbox\" data-bind=\"visible: editState() === 'patched', click: togglePatchLine.bind($data, ").concat(index, ")\"></input></div>");
    };
