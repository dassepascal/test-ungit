...
var PathViewModel = /** @class */ (function (_super) {
    ...
    PathViewModel.prototype.initRepository = function () {
        var _this = this;
        return this.server
            .postPromise('/init', { path: this.repoPath() })["catch"](function (e) { return _this.server.unhandledRejection(e); })["finally"](function () { return _this.updateStatus(); });
    };
    ...
    PathViewModel.prototype.cloneRepository = function () {
        ...
        return this.server
            ...
            .then(function (res) { return navigation.browseTo('repository?path=' + addressParser.encodePath(res.path)); })["catch"](function (e) { return _this.server.unhandledRejection(e); })["finally"](function () {
            programEvents.dispatch({ event: 'working-tree-changed' });
        });
    };
    PathViewModel.prototype.createDir = function () {
        ...
        return this.server
            .postPromise('/createDir', { dir: this.repoPath() })["catch"](function (e) { return _this.server.unhandledRejection(e); })
